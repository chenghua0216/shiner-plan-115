...
export default function App() {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      desc: "採先到先審制；學校在提交後約 3-5 個工作天會收到會談通知；若資格不符，將以電話或 Email 寄發通知。",
      colorTheme: {
        dot: "bg-orange-500",
        phase: "text-orange-500",
        date: "text-orange-600",
  ...
  return (
    <div className="font-sans text-gray-800 bg-orange-50 min-h-screen">
      {/* Navbar */}
      ...
      <section id="hero" className="pt-40 md:pt-52 pb-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2 space-y-6">
          ...
          <div className="text-xl text-gray-600 leading-relaxed">
            ...
            整合「多元探索」與「教師支持」雙軌系統，為偏遠地區學校打造兼具心理安全感與創造力自信的永續教育生態。
          </div>
      ...
      <section id="purpose" className="py-20 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-lg text-gray-700 leading-relaxed space-y-6 px-4 md:px-8 text-justify">
            <p>
              立賢教育基金會自 2008 年起，長期深耕偏遠地區教育現場。從早期「蒲公英的冒險多元課程」到近年推動「超能力解鎖多元探索計畫」、「教師支持計畫」，我們始終與師生並肩同行。在長期的陪伴中，我們也深刻體會到，教育現場的核心挑戰，往往來自內在動機的匱乏與高壓環境下心理能量的消耗。
            </p>
            <p>
              腦科學與心理學研究指出，創造力不僅是藝術表現或解決問題的思考，更是維繫心理健康、建立自我認同與情緒調節的關鍵。在創作歷程中，能有效提升專注力、轉化壓力並厚植心理韌性，引導師生找回內在覺察，以及與生活的深度連結。
            </p>
            <p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100 flex flex-col h-full">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">為教師：挹注支持的力量，賦能並照顧身心</h3>
              <ul className="space-y-4 text-gray-600 flex-grow">
                <li><strong className="text-gray-800 block mb-1">身心支持：</strong>邀請各領域專業講師，透過團體分享、肢體或戲劇表演、藝術療癒等多元活動，陪伴老師釋放教學現場的壓力；藉由內在覺察引導創造力的實踐，讓老師的身心先獲得修復與照顧，轉化為守護學生的堅韌力量。</li>
                <li><strong className="text-gray-800 block mb-1">專業賦能：</strong>透過工作坊或師生共學模式，促進師生深度對話，並讓老師掌握多元對話引導鷹架和技巧，在過程中看見學生不同面向的潛能與表達方式，進而激發班級經營的新靈感。</li>
              </ul>
            </div>
            {/* 學校 */}
            <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100 flex flex-col h-full">
              ...
              <ul className="space-y-4 text-gray-600 flex-grow">
                ...
                <li><strong className="text-gray-800 block mb-1">支持系統：</strong>建立以心理健康與相互支持為核心的校園氛圍。</li>
